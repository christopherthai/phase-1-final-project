...
const isArguments_js_1 = require("./isArguments.js");
const isBuffer_js_1 = require("./isBuffer.js");
const isDate_js_1 = require("./isDate.js");
const isError_js_1 = require("./isError.js");
const isGeneratorObject_js_1 = require("./isGeneratorObject.js");
const isMoment_js_1 = require("./isMoment.js");
const isRegExp_js_1 = require("./isRegExp.js");
var ValueType;
(function (ValueType) {
...
function typeOf(value) {
    ...
    if ((0, isMoment_js_1.isMoment)(value)) {
    ...
    if ((0, isBuffer_js_1.isBuffer)(value)) {
        return ValueType.buffer;
    }
    if ((0, isArguments_js_1.isArguments)(value)) {
        return ValueType.arguments;
    }
    if ((0, isDate_js_1.isDate)(value)) {
        return ValueType.date;
    }
    if ((0, isError_js_1.isError)(value)) {
        return ValueType.error;
    }
    if ((0, isRegExp_js_1.isRegExp)(value)) {
    ...
    if ((0, isGeneratorObject_js_1.isGeneratorObject)(value)) {
